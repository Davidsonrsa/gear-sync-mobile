...
function parseExcelDate(value: unknown): string | null {
  ...
  if (match) {
    ...
    if (!isValidDate(yearNumber, month, day)) {
      return null;
    }

    return `${yearNumber}-${String(month).padStart(2, "0")}-${String(day).padStart(2, "0")}`;
  }
            ...
            {previewData.length > 50 && (
              <div
                className="
                  ...
                  "
              >
                Mostrando os primeiros <strong className="text-gray-900">50</strong> registros.
                <br />
                Os{" "}
                <strong className="text-gray-900">
                  {previewData.length.toLocaleString("pt-BR")}
